					...
					<div class="row">
						<?php foreach ($chitietsanpham as  $dlsanpham): ?>
							...
							<div class="col-sm-4">
								...
								<a href="<?php echo base_url('Shopping/add')?>" class="btn btn-outline-success btn-lg">Add Cart</a>
							</div>
						<?php endforeach ?>
						...
						<?php foreach ($chitietsanpham as  $dlsanpham): ?>
							...
							<div class="col-sm-4">
								<form action="<?php echo base_url('Shopping/add')?>" method="post">
									<input type="text" name="gia" value="<?php echo $dlsanpham['gia']?>">
									<input type="text" name="tensp" value="<?php echo $dlsanpham['tensp'] ?>">
									<button type="submit" name="acion">them</button>
								</form>
					 			...
					 			<div class="card-deck">
					 				<div class="card">
					 					...
					 					<div class="card-block">
					 						...
					 						<h2 class=" text-xs-center"><?php echo $value['gia'] ?>đ</h2>
					 					</div>
					 				</div>
					 			</div>
					 		</div>
